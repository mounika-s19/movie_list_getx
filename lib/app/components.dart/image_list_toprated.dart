...
class ImageListTopRated extends StatefulWidget {
  const ImageListTopRated({Key? key, this.startFrom = 0, this.duration = 30}) : super(key: key);
  final int startFrom;
  final int duration;
  @override
  State<ImageListTopRated> createState() => _ImageListTopRatedState();
}

class _ImageListTopRatedState extends State<ImageListTopRated> {
  final ScrollController _scrollController = ScrollController();
  final TopRatedController _topRatedController = Get.put(TopRatedController());
