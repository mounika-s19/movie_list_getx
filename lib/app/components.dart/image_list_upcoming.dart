...
class ImageListUpComing extends StatefulWidget {
  const ImageListUpComing({Key? key, this.startFrom = 0, this.duration = 30}) : super(key: key);
  final int startFrom;
  final int duration;
  @override
  State<ImageListUpComing> createState() => _ImageListUpComingState();
}

class _ImageListUpComingState extends State<ImageListUpComing> {
